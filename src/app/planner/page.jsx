                ...
                <div className="space-y-4">
                    {days.map((day, index) => {
                        ...
                        return (
                            <div
                                key={day}
                                className={`rounded-2xl border-2 p-4 transition-colors ${hasOutfit
                            ...
                            >
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="text-center">
                                        ...
                                        <div className={`size-12 rounded-full flex items-center justify-center font-bold ${hasOutfit
                                    ...
                                    <Link
                                        href="/outfits"
                                        className={`size-10 rounded-full flex items-center justify-center ${hasOutfit
